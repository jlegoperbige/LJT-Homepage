...
I am **Junteng Liu**, a first-year PhD candidate at **HKUST NLP Group**. My research focuses on **natural language processing and machine learning**. My specific research interests include:
...
5. **C-Eval: A Multi-Level Multi-Discipline Chinese Evaluation Suite for Foundation Models** (NeurIPS 2023)  
   Yuzhen Huang, Yuzhuo Bai, Zhihao Zhu, Junlei Zhang, Jinghan Zhang, Tangjun Su, *Junteng Liu*, Chuancheng Lyi, Yikai Zhang, Jiayi Lei, Yao Fu, Maosong Sun, Junxian He
